...
function getMortarBoard(isFilled: boolean) {
  return isFilled ? (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
      className="w-6 h-6 z-20 swap-on"
    >
...
function getPinSVG(filled: boolean = false) {
  return filled ? (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
      viewBox="0 0 24 24"
      strokeWidth={1.5}
      className="w-6 h-6 swap-off z-10"
    >
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
    ...
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
      className="w-6 h-6 swap-on  z-10"
    >
      <path
        fillRule="evenodd"
...
function getArrowLeftCircleSVG(isFilled: boolean) {
  return isFilled ? (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
